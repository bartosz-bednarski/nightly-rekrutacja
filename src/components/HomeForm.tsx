...
const HomeForm: Component<{
  ...
  const [menuIsShown, setMenuIsShown] = createSignal(false);
  ...
  return (
    <>
      <div class="relative flex flex-col bg-background-component shadow-withdraw-shadow border-2 border-border-component h-492px text-white mt-16 mr-10 mb-52 ml-14 p-4 w-332px rounded-lg">
